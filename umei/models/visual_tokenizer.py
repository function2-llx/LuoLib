...
class VisualTokenizer(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.token_shape = (
            encoder_config['img_size'] // self.patch_size, encoder_config['img_size'] // self.patch_size)
        ...
        self.encode_task_layer = nn.Sequential(
            ...
            nn.Tanh(), nn.Linear(encoder_config['embed_dim'], embed_dim)
            # for quantize
        )
    ...
    def no_weight_decay(self):
        return {'quantize.embedding.weight', 'decoder.cls_token', 'decoder.pos_embed', 'encoder.cls_token',
            'encoder.pos_embed'}
