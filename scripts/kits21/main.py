...
from umei.datasets.kits21 import KiTS21Args, KiTS21DataModule
...
def main():
    parser = UMeIParser((KiTS21Args, ), use_conf=True)
    args: KiTS21Args = parser.parse_args_into_dataclasses()[0]
    ...
    print(args)
    datamodule = KiTS21DataModule(args)
